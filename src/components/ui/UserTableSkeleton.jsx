  ...
  <tr className="animate-pulse">
    <td className="px-6 py-4">
      <div className="flex items-center gap-3">
        <div className="bg-background-primary h-10 w-10 rounded-full" />
        <div className="flex-1 space-y-2">
          <div className="bg-background-primary h-4 w-32 rounded" />
          <div className="bg-background-primary h-3 w-48 rounded" />
          <div className="bg-background-primary h-3 w-28 rounded" />
        </div>
      </div>
    </td>
    <td className="px-6 py-4">
      <div className="bg-background-primary h-6 w-16 rounded-full" />
    </td>
    <td className="px-6 py-4">
    ...
    <td className="px-6 py-4">
      <div className="flex items-center justify-end gap-2">
        <div className="bg-background-primary h-8 w-20 rounded" />
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <div className="bg-background-secondary h-4 w-40 animate-pulse rounded" />
        </div>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-background-primary border-border-default border-b">
              <tr>
                ...
                <th className="px-6 py-3 text-left">
                  <div className="bg-background-secondary h-4 w-16 animate-pulse rounded" />
                </th>
                <th className="px-6 py-3 text-left">
