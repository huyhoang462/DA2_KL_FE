          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="bg-background-primary mb-2 h-4 w-16 rounded"></div>
                <div className="bg-background-primary h-8 w-20 rounded"></div>
              </div>
              <div className="bg-background-primary h-12 w-12 rounded-full"></div>
            </div>
            <div className="bg-background-primary mt-3 h-4 w-24 rounded"></div>
          </div>
        ))}
      </div>
...
export default TicketReportSkeleton;
