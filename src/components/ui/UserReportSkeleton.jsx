  ...
  return (
    <div className="animate-pulse space-y-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <div className="bg-background-primary h-8 w-16 rounded"></div>
              </div>
              <div className="bg-background-primary h-12 w-12 rounded-full"></div>
            </div>
            <div className="bg-background-primary mt-3 h-4 w-32 rounded"></div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-background-secondary border-border-default rounded-lg border p-6">
        <div className="bg-background-primary mb-6 h-6 w-56 rounded"></div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {[1, 2].map((i) => (
          <div
            ...
            className="bg-background-secondary border-border-default rounded-lg border p-6"
          >
            <div className="bg-background-primary mb-6 h-6 w-40 rounded"></div>
            <div className="bg-background-primary h-[300px] w-full rounded-lg"></div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-background-secondary border-border-default rounded-lg border">
        <div className="border-border-default border-b p-6">
          <div className="bg-background-primary h-6 w-40 rounded"></div>
        </div>
